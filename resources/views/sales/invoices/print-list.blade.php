...
@section('title', 'Register Faktur Penjualan — ' . ($currentCompany->name ?? 'AKRU'))
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
    ...
    <div style="text-align: right;">
        <h2 style="font-size: 14pt; font-weight: bold; color: #1e293b; margin-bottom: 4px;">REGISTER FAKTUR PENJUALAN</h2>
...
<table style="width: 100%; margin-top: 15px;">
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="9" style="text-align: center; padding: 20px; color: #94a3b8;">Tidak ada data faktur penjualan.</td>
        </tr>
        @endforelse
    </tbody>
    <tfoot>
...
<div class="signature-box">
    ...
    <div class="signature-line">{{ auth()->user()->name ?? 'Sales Admin' }}</div>
</div>
<div class="signature-box">
